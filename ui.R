    ...
    navbarPage("",
               ...
               tabPanel("Single cell RNA-Sequencing",
                        navlistPanel(widths=c(2,10),
                                     ...
                                     tabPanel(  
                                              tags$div(
                                                HTML(paste(tags$img(src="number1.png", height = 25, width = 25),  "Upload your data", sep = ""))
                                              ),
                                              column(9,
                                                     column(5,
                                                            #h4('Load Data:'),
                                    ...
                                    #         ),
                                     tabPanel( tags$div(
                                       HTML(paste(tags$img(src="number2.png", height = 25, width = 25),  "Normalization & Feature Selection", sep = ""))
                                     ), value = "test",
                                     ...
                                     tabPanel( tags$div(
                                       HTML(paste(tags$img(src="number3.png", height = 25, width = 25),  "PCA", sep = ""))
                                     ), value = "test1",
                                    ...
                                    tabPanel( tags$div(
                                      HTML(paste(tags$img(src="number4.png", height = 25, width = 25),  "UMAP", sep = ""))
                                    ), value = "test2",
                                    ...
                                    tabPanel( tags$div(
                                      HTML(paste(tags$img(src="number4.png", height = 25, width = 25),  "tSNE", sep = ""))
                                    ), value = "test2",
                                    ...
                                    tabPanel( tags$div(
                                      HTML(paste(tags$img(src="number4.png", height = 25, width = 25),  "Clustering", sep = ""))
                                    ), value = "test2",
                                     ...
                                     tabPanel(tags$div(
                                       HTML(paste(tags$img(src="number5.png", height = 25, width = 25),  "Cell Type Identification", sep = ""))
                                     ), value = "test3",
                                     ...
                                     tabPanel(tags$div(
                                       HTML(paste(tags$img(src="number5.png", height = 25, width = 25),  "Cell Type Similarity", sep = ""))
                                     ), value = "test4",
                                      ...
                                      tabPanel(tags$div(
                                        HTML(paste(tags$img(src="number6.png", height = 25, width = 25),  "DEGs", sep = ""))
                                      ), value = "test5",
                                     ...
                                     tabPanel(tags$div(
                                       HTML(paste(tags$img(src="number6.png", height = 25, width = 25),  "Data visualization", sep = ""))
                                     ), value = "test5",
                                     ...
                                     tabPanel(tags$div(
                                       HTML(paste(tags$img(src="number7.png", height = 25, width = 25),  "GSEA", sep = ""))
                                     ), value = "test6",
                                     ...
                                     tabPanel(tags$div(
                                       HTML(paste(tags$img(src="number7.png", height = 25, width = 25),  "Cell-cell communication", sep = ""))
                                     ), value = "test6",
                                              ...
                                              column(3,
                                                     br(),
                                                     br(),
                                                     actionBttn("doCC", "Run CellPhoneDB", icon = icon("hand-pointer-o"), size = 'sm'),
                                              ...
                                              column(12,
                                              h4(p("Mean values for all the interacting partners")),
                                                      ),
               ...
               tabPanel("Single cell data integration", 
                        ...
                        tabPanel("Celltype similarity", value = "test_intg6",
                        ...
                        tabPanel("Cell-cell communication", value = "test_intg8",
                                 ...
                                 br(),
                                 column(12,
                                        plotlyOutput("CC_plot1a", width = "100%"),
                                 ),
                                 br(),
                                 column(12,
                                 column(3,
                                        uiOutput("CC.gene.select2"),
                                        ),
                                      ),
                                 column(12,
                                 ...
                                 br(),
                                 h4(p("p-values for the all the interacting partners")),
                                 withSpinner(dataTableOutput('cc.table1b')),
                          ),
                        #tabPanel("13. Annotate scATAC-seq data using scRNA-seq data",
                        #         tags$head(tags$script('
               ...
               tabPanel("Spatial Transcriptomics",
                        ...
                        navlistPanel(widths=c(2,10),
                                     ...
                                     #         ),
                                     #),
                                     tabPanel("2. Normalization and Variable Feature Selection", value = "test_sp",
                                     ...
                                     tabPanel("3. Gene expression visualization", value = "test_sp",
                                     ...
                                     tabPanel("5. Clustering",  value = "test_sp2",
                                     ...
                                     tabPanel("6. UMAP",  value = "test_sp2",
                                              ...
                                              conditionalPanel(
                                                ...
                                                column(9,
                                                       br(),
                                                       br(),
                                                       plotlyOutput("DimPlot_GraphST", width = "100%"),
                                                       br(),
                                     ...
                                     tabPanel("7. DEG Analysis", value = "test_sp3",
                                     ...
                                     tabPanel("8. Deconvolution", value = "test_sp4",
                                              ...
                                              conditionalPanel(
                                                ...
                                                column(9,
                                                 ...
                                                 tabPanel("9. Visualize", value = "test_sp5",
                                                  ...
                                                  '
                                                        ...
                                                        tabPanel(title="Visualize Spatial Domains", value="Vis_sp_panel2",
                                                                 ...
                                                                 tabPanel("10. GSEA", value = "test_sp5",
               ...
               tabPanel("Single cell multiomics",
                        navlistPanel(widths=c(2,10),
                                     ...
                                     tabPanel("2. Normalization and Variable Feature Selection", value = "test_mult",
                                     ...
                                     tabPanel("3. PCA", value = "test_mult1",
                                                ...
                                                tabsetPanel(id="Pca_mult_mofa2",
                                                            tabPanel(title="Data overview",
                                                                     ...
                                                                     fluidRow(
                                                                       ...
                                                                       column(3,
                                                                              br(),
                                                                              actionBttn("runMOFA_mult", "Run MOFA2", icon = icon("hand-pointer-o"), size = "sm", onclick = "$(tab_mult2).removeClass('disabled')")
                                                                       ),
                                                                     ),
                                                                     br(),
                                     ...
                                     tabPanel("4. UMAP", value = "test_mult2",
                                     ...
                                     tabPanel("5. Clustering", value = "test_mult3",
                                     ...
                                     tabPanel("6. Cell type identification", value = "test_mult4",
                                     ...
                                     tabPanel("7. DEGs", value = "test_mult5",
                                              ...
                                              conditionalPanel(
                                                ...
                                                fluidRow(
                                                  ...
                                                  br(),
                                                  column(3,
                                                         actionBttn("doDeg_mult", "Run DEGs", icon = icon("hand-pointer-o"), size = 'sm', onclick = "$(tab_mult6).removeClass('disabled')"),
                                                         #bsPopover("doDeg", "Perform DEG Analysis","Press to run DEG Analysis", placement = "bottom", trigger = "hover", options = NULL),
                                                  )),
                                                br(),
                                                column(12,
                                              ...
                                              conditionalPanel(
                                                ...
                                                column(12,
                                                       ...
                                                       br(),
                                                       column(3,
                                                              actionBttn("doVolcano_mult", "Run Pairwise DEGs", icon = icon("hand-pointer-o"), size = 'sm', onclick = "$(tab_mult6).removeClass('disabled')"),
                                                              #bsPopover("doVolcano", "Perform Pairwise DEG Analysis","Press to run Pairwise DEG Analysis", placement = "bottom", trigger = "hover", options = NULL),
                                                       ),
                                                ),
                                                column(12,
                                     ...
                                     tabPanel("8. Data Visualization", value = "test_mult6",
                                           ...
                                           tabPanel("9. Cell type Similarity", value = "test_mult6",
                                                ...
                                                tags$script(
                                                  ...
                                                  '
                                                    ...
                                                    column(3,
                                                           br(),
                                                           br(),
                                                           actionBttn("cell_cell_mult", "Run celltype similarity", icon = icon("hand-pointer-o"), size = 'sm', onclick = "$(tab_mult7).removeClass('disabled')"),
                                                           #bsPopover("cell_cell", "Perform Celltype Similarity","Press to run Celltype Similarity Analysis", placement = "bottom", trigger = "hover", options = NULL),
                                     ...
                                     tabPanel("10. GSEA", value = "test_mult7",
               ...
               tabPanel("Single cell ATAC-seq",
                        ...
                        navlistPanel(widths=c(2,10),
                                     ...
                                     tabPanel("2. Normalization", value = "test_atac",
                                     ...
                                     tabPanel("3. Clustering", value = "test_atac1",
                                       ...
                                       fluidRow(
                                         ...
                                         column(3,
                                                br(),
                                                actionBttn("doCluster_ATAC", "Run Clustering", icon = icon("hand-pointer-o"), size = "sm", onclick = "$(tab_atac2).removeClass('disabled')"),
                                     ...
                                     tabPanel("4. UMAP", value = "test_atac2",
                                       ...
                                       fluidRow(
                                         ...
                                         br(),
                                         column(3,
                                                actionBttn("doUMAP_ATAC", "Run UMAP", icon = icon("hand-pointer-o"), size = "sm", onclick = "$(tab_atac3).removeClass('disabled')"),
                                     ...
                                     tabPanel("5. tSNE", value = "test_atac3",
                                              
                                              tags$script(
                                                '
                                                  var tab_atac3 = $(\'a[data-value="test_atac3"]\').parent().addClass("disabled");
                                                  $(function(){
                                                    $(tab_atac.parent()).on("click", "li.disabled", function(e) {
                                                      e.preventDefault();
                                                      return false;
                                     ...
                                     tabPanel("6. Calculate gene activity", value = "test_atac4",
                                     ...
                                     tabPanel("7. Celltype identification", value = "test_atac5",
                                     ...
                                     tabPanel("8. DE Peaks", value = "test_atac6",
                                    ...
                                    tabPanel("9. Target Predict (Link Peaks to Genes)", value = "test_atac7",
                                    ...
                                    tabPanel("10. Gene Set Enrichment Analysis for scATAC-seq", value = "test_atac8",
                                    ...
                                    tabPanel("10. Data visualization", value = "test_atac9",
                                     ...
                                     tabPanel("11. Coverage Plot", value = "test_atac9",
